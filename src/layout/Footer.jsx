...
const Footer = () => {
  return (
    <footer className="w-full max-w-7xl mx-auto border-t border-gray-200 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex mb-4">
              ...
              />
              <button className="bg-[#23A6F0] text-white px-9 py-8 text-sm font-medium hover:bg-blue-600 transition-colors">
                Subscribe
              </button>
            </div>
      ...
      <div className="border-10 border-gray-100 bg-gray-100 px-4 md:px-8 py-4 text-left mt-8">
